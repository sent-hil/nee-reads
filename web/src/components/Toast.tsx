    ...
    <div className="fixed bottom-24 left-1/2 z-50 w-max max-w-[90%] toast-animate">
      <div className="flex items-center justify-between gap-4 pl-4 pr-2 py-2.5 bg-gray-900/95 backdrop-blur-md text-white rounded-2xl shadow-floating border border-white/10 ring-1 ring-black/10">
        ...
        <div className="flex items-center gap-1">
          <button
            onClick={handleUndo}
            className="ml-2 flex items-center justify-center px-2 py-1 rounded-full hover:bg-white/10 transition-colors group"
          >
            <span className="text-gray-400 group-hover:text-white text-[10px] sm:text-xs font-bold uppercase tracking-wide">
              Undo
            </span>
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center w-6 h-6 rounded-full hover:bg-white/10 transition-colors group"
            aria-label="Dismiss"
          >
            <span className="material-icons-round text-gray-400 group-hover:text-white text-sm">
              close
            </span>
          </button>
        </div>
